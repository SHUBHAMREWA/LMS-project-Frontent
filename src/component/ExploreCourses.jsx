...
Unlock your potential with our expertly designed courses that combine real-world skills, interactive learning, and hands-on projects. Whether you’re passionate about web development, design, or emerging technologies, our courses are crafted to help you learn at your own pace and achieve your goals faster.
                ...
                <button className='font-semibold text-white bg-black  border-2  lg:text-xl
...
{/* right section */}
        <div className='lg:w-[50%] w-[60%] flex flex-wrap lg:gap-6 gap-5 text-[12px] lg:text-[16px] justify-center' >  
              ...
              <div className='flex justify-center items-center  flex-col text-center  '> 
                ...
                <div className='py-5 px-4 text-[#3f3a3a]  text-5xl bg-pink-500 rounded-2xl'>
                    <LiaLaptopCodeSolid/>
                </div>
              ...
              <div className='flex justify-center items-center flex-col text-center '>
                <div className='py-5 px-4 text-[#3f3a3a]  text-5xl bg-blue-500 rounded-2xl'>
                    <FaUikit/>
                </div>
    ...
    <div className='flex justify-center items-center flex-col text-center '>
                <div className='py-5 px-4 text-[#3f3a3a]  text-5xl bg-green-500 rounded-2xl'>
                    <TbBrandHackerrank/>
                </div>
...
<div className='flex justify-center items-center flex-col text-center '>
                <div className='py-5 px-4 text-[#3f3a3a]  text-5xl bg-orange-500 rounded-2xl'>
                    <PiOpenAiLogoBold/>
                </div>
                <span>AI/ML</span>
              </div>
...
<div className='flex justify-center items-center flex-col text-center '>
                <div className='py-5 px-4 text-[#3f3a3a]  text-5xl bg-emerald-700 rounded-2xl'>
                    <PiDeviceMobileFill/>
                </div>
                <span>App Dev</span>
              </div>  
              ...
              <div className='flex justify-center items-center flex-col text-center '>
                <div className='py-5 px-4 text-[#3f3a3a]  text-5xl bg-amber-400 rounded-2xl'>
                    <SiDatastax/>
                </div>
              ...
              <div className='flex justify-center items-center flex-col text-center '>
                <div className='py-5 px-4 text-[#3f3a3a]  text-5xl bg-red-600 rounded-2xl'>
              ...
              <div className='flex justify-center items-center flex-col text-center '>
                <div className='py-5 px-4 text-[#3f3a3a]  text-5xl bg-fuchsia-700 rounded-2xl'>
                    <GiArtificialHive/>
                </div>
                <span>Ai Tools</span>
              </div>
