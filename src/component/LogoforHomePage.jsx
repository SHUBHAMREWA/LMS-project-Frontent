...
const LogoforHomePage = () => {
  return (
    <div>
        <div 
        className='w-[100%] min-h-[80px]  flex-wrap flex justify-center items-center bg-white lg:gap-6 gap-2'
        >

            <div className='bg-[#e5e7e9] rounded-xl lg:px-2 lg:py-2 shadow-md flex lg:text-xl text-sm px-1 py-1 text-[#02a17e] 
